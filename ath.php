...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.php">Home</a><label>/</label>Automobiles<label>/</label>4-Wheelers</h3>
		<div class="clearfix"> </div>
	</div>
</div>
	<!--content-->
        ...
        <div class="col-md-6 animated wow fadeInRight" data-wow-delay=".5s">
          <div class="grid-pro">
            <div class="grid-product">
                  <br><br><br>
                   <h3>Stock Update Recieved!....<br></h3><h4><br><br>Details have been Submitted and will<br>be reflected in Website During the Maintenances hours.</h4><br><br><br><br><br><br>
                </div>
              </div>
              </div>
              <div class="col-md-3 product-bottom">
