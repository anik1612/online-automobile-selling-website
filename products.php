...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index.php">Home</a><label>/</label>Products<label>/</label>4-Wheelers</h3>
		<div class="clearfix"> </div>
	</div>
</div>
	<!--content-->
			...
			<div class="sellers animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/gmc1.jpg" alt=""></a>

								</div>
							<div class=" fashion-grid1">
								<h6 class="best2"><a href="single.php">Sierra Denali </a></h6>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single.php"><img class="img-responsive " src="images/mah1.jpg" alt=""></a>

								</div>
							<div class=" fashion-grid1">
								<h6 class="best2"><a href="single.php">Scorpio </a></h6>
								<span class=" price-in1"> <del>$50.00</del>$40.00</span>
								<p>The next generation SUV is merely an update to comply with
									 the new BS-IV norms and retains all the desirable traits of the Scorpio.</p>
							</div>
							<div class="clearfix"> </div>
							</div>
				...
				<div class="col-sm-4 item-grid item-gr  simpleCart_shelfItem">
						...
						<div class="col-sm-4 item-grid item-gr simpleCart_shelfItem">
							<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.php">SX-4</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="single.php" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>
										<a href="single.php">
											<div class="grid-img">
												<img  src="images/mah1.jpg"  width="350px" height="100px" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/mah2.jpg"  width="350px" height="100px"  alt="">
											</div>
										</a>
									</figure>
								</div>
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.php">Scorpio</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="single.php" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
						...
						<div class="col-sm-4 item-grid item-gr simpleCart_shelfItem">
							<div class="grid-pro">
								...
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.php">Nano</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="single.php" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>
										<a href="single.php">
											<div class="grid-img">
												<img  src="images/nis1.jpeg" width="350px" height="100px" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/nis2.jpg" width="350px" height="100px"  alt="">
											</div>
										</a>
									</figure>
								</div>
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.php">Sunny</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="single.php" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
							...
							<div class="grid-pro">
								<div  class=" grid-product " >
									<figure>
										<a href="single.php">
											<div class="grid-img">
												<img  src="images/ford1.png" width="350px" height="100px" alt="">
											</div>
											<div class="grid-img">
												<img  src="images/ford2.jpg" width="350px" height="120px"  alt="">
											</div>
										</a>
									</figure>
								</div>
								<div class="women">
									<a href="#"><img src="images/ll.png" alt=""></a>
									<h6><a href="single.php">Ecosport</a></h6>
									<p ><del>$100.00</del><em class="item_price">$70.00</em></p>
									<a href="single.php" data-text="Check it!" class="but-hover1 item_add">Buy Now!</a>
								</div>
							</div>
